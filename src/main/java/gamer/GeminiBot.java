/**
 * Represents an advanced AI opponent ("Medium" difficulty) that utilizes strategic evaluation. It
 * builds a threat map to avoid dangerous tiles, prioritizes capturing valuable structures (HQ,
 * Factories), and dynamically purchases counter-units based on the enemy's army composition.
 *
 * @author xpruzir00
 * @author xblizna00 (Note: The initial structure of this bot was generated by AI, as documented in
 *         audit_ai.md)
 */
